 ...
 *
 * Autenticaci├│n (en orden de prioridad):
 *   1. env BLOB_READ_WRITE_TOKEN (token est├ítico)
 *   2. env VERCEL_OIDC_TOKEN + env BLOB_STORE_ID (conexi├│n OIDC)
 *
 * Endpoints (seg├║n SDK oficial):
 *   - Escritura/listado/borrado ÔåÆ https://vercel.com/api/blob/ (control-plane)
 *     con header x-vercel-blob-store-id
 *   - Lectura ÔåÆ https://{storeId}.private.blob.vercel-storage.com/{path}
 *
 * Funciones:
 *   blobGet($path)               ÔåÆ string|false
 *   blobPut($path, $data, $opts) ÔåÆ array (url, size, pathname)
 *   blobList($prefix)            ÔåÆ array [{pathname, size, url}]
 *   blobDeletePrefix($prefix)    ÔåÆ int
 *   blobDeleteUrls($urls)        ÔåÆ int
 */
...
// ÔöÇÔöÇ GET (leer) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ PUT (escribir) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
function blobPut(string $path, string $data, array $opts = []): array|false {
    ...
    // Fallback: stream_context_create si curl fall├│ o no existe
...
// ÔöÇÔöÇ LIST ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ DELETE ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
